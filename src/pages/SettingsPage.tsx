      ...
      <form onSubmit={handleSave} className="max-w-2xl mx-auto space-y-4 animate-fade-in">
        ...
        <Card>
          ...
          <CardContent className="grid gap-3 sm:grid-cols-2 px-4">
            ...
            <div className="space-y-1"><Label className="text-xs">Phone</Label><Input value={seller.phone} onChange={(e) => handleUpdate({ phone: e.target.value })} placeholder="9487519401" className="h-9 text-sm" /></div>
            ...
            <div className="space-y-1"><Label className="text-xs">GSTIN</Label><Input value={seller.gstin} onChange={(e) => handleUpdate({ gstin: e.target.value.toUpperCase() })} placeholder="33AQBPM0647A1ZJ" maxLength={15} className="font-mono h-9 text-sm" /></div>
